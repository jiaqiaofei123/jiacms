    ...
    <div class="layui-card">
        <div class="layui-card-header layuiadmin-card-header-auto">
            <div class="layui-btn-group ">
                ...
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('message.message.create')): ?>
                    <a class="layui-btn layui-btn-sm" href="<?php echo e(route('admin.message.create')); ?>">添加</a>
                <?php endif; ?>
