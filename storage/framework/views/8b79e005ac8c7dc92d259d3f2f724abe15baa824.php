<?php $__env->startSection('content'); ?>
    <header id="container2" style="background: #226039 url(<?php echo e(asset('home/images/bg-girl.jpg')); ?>) center 0 scroll no-repeat;">
    ...
    <div class="mainContent">
        ...
        <aside>
            <div class="sidebar-avatar">
                <div class="avatar"> <a href="/about"> <img src="<?php echo e($user->avatar); ?>"> </a> </div>
                <div class="userinfo">
            ...
            <div id="float_a" class="div_a">
                <div id="div-pin"></div>
                <div id="float" class="div1"> <a href="/" ><img src="<?php echo e($user->avatar); ?>"></a> </div>
            </div>
        </aside>
        <!-- 侧栏跟随 -->
