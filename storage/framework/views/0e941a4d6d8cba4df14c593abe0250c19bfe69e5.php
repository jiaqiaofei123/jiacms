...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('/home/images/lmlblog.png')); ?>" />
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('/home/css/jquery.fancybox.css')); ?>" media="screen" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('/home/css/tips.css')); ?>" />
...
<footer>
    <div class="footavatar"> <img src="<?php echo e($user->avatar); ?>" class="footphoto">
        <ul class="footinfo">
            <p class="fname"><a href="/about" ><?php echo e($user->name); ?></a> </p>
    ...
    <section class="visitor">
        ...
        <ul>
            <li><a href="/" rel="nofollw" title="动漫资讯"><img src="<?php echo e(asset('/home/images/s2.jpg')); ?>"></a></li>
            <li><a href="/" rel="nofollw" title="超神学院"><img src="<?php echo e(asset('/home/images/s1.jpg')); ?>"></a></li>
            <li><a href="/" rel="nofollw" title="唯美说说乐园"><img src="<?php echo e(asset('/home/images/s0.gif')); ?>"></a></li>
        </ul>
    </section>
    <div class="Copyright">
        <div class="n-a">
...
<script type="text/javascript" src="<?php echo e(asset('/home/js/tips.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('/home/js/base.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('/home/js/jquery.mousewheel-3.0.6.pack.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('/home/js/jquery.fancybox.js')); ?>"></script>
</html>