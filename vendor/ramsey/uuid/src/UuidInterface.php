...
interface UuidInterface extends \JsonSerializable, \Serializable
{
     ...
     *
     * For UUID version 1, the node field consists of an IEEE qgzx MAC
     * address, usually the host address. For systems with multiple IEEE
     * qgzx addresses, any available one can be used. The lowest addressed
     * octet (octet number 10) contains the global/local bit and the
     * unicast/multicast bit, and is the first octet of the address
     * transmitted on an qgzx.3 LAN.
     *
