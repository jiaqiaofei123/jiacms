...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'middleware' => ['auth', 'permission:home.manage']], function () {
    //导航管理
    Route::group(['middleware' => 'permission:home.nav'], function () {
        Route::get('nav/data', 'NavController@data')->name('admin.nav.data');
        Route::get('nav', 'NavController@index')->name('admin.nav');
        //添加分类
        Route::get('nav/create', 'NavController@create')->name('admin.nav.create');
        Route::post('nav/store', 'NavController@store')->name('admin.nav.store')->middleware('permission:home.nav.create');
        //编辑分类
        Route::get('nav/{id}/edit', 'NavController@edit')->name('admin.nav.edit')->middleware('permission:home.nav.edit');
        Route::put('nav/{id}/update', 'NavController@update')->name('admin.nav.update')->middleware('permission:home.nav.edit');
        //删除分类
        Route::delete('nav/destroy', 'NavController@destroy')->name('admin.nav.destroy')->middleware('permission:home.nav.destroy');
    });
    //分类管理
    Route::group(['middleware' => 'permission:home.category'], function () {
        Route::get('category/data', 'CategoryController@data')->name('admin.category.data');
        Route::get('category', 'CategoryController@index')->name('admin.category');
        //添加分类
        Route::get('category/create', 'CategoryController@create')->name('admin.category.create');
        Route::post('category/store', 'CategoryController@store')->name('admin.category.store')->middleware('permission:home.category.create');
        //编辑分类
        Route::get('category/{id}/edit', 'CategoryController@edit')->name('admin.category.edit')->middleware('permission:home.category.edit');
        Route::put('category/{id}/update', 'CategoryController@update')->name('admin.category.update')->middleware('permission:home.category.edit');
        //删除分类
        Route::delete('category/destroy', 'CategoryController@destroy')->name('admin.category.destroy')->middleware('permission:home.category.destroy');
    });
    //文章管理
    Route::group(['middleware' => 'permission:home.article'], function () {
        ...
        //添加
        Route::get('article/create', 'ArticleController@create')->name('admin.article.create')->middleware('permission:home.article.create');
        Route::post('article/store', 'ArticleController@store')->name('admin.article.store')->middleware('permission:home.article.create');
        //编辑
        Route::get('article/{id}/edit', 'ArticleController@edit')->name('admin.article.edit')->middleware('permission:home.article.edit');
        Route::put('article/{id}/update', 'ArticleController@update')->name('admin.article.update')->middleware('permission:home.article.edit');
        //删除
        Route::delete('article/destroy', 'ArticleController@destroy')->name('admin.article.destroy')->middleware('permission:home.article.destroy');
    });
    //日记陈述
    Route::group(['middleware' => 'permission:home.statement'], function () {
        Route::get('statement/data', 'StatementController@data')->name('admin.statement.data');
        Route::get('statement', 'StatementController@index')->name('admin.statement');
        //添加
        Route::get('statement/create', 'StatementController@create')->name('admin.statement.create')->middleware('permission:home.statement.create');
        Route::post('statement/store', 'StatementController@store')->name('admin.statement.store')->middleware('permission:home.statement.create');
        //编辑
        Route::get('statement/{id}/edit', 'StatementController@edit')->name('admin.statement.edit')->middleware('permission:home.statement.edit');
        Route::put('statement/{id}/update', 'StatementController@update')->name('admin.statement.update')->middleware('permission:home.statement.edit');
        //删除
        Route::delete('statement/destroy', 'StatementController@destroy')->name('admin.statement.destroy')->middleware('permission:home.statement.destroy');
    });
    //标签管理
    Route::group(['middleware' => 'permission:home.tag'], function () {
        Route::get('tag/data', 'TagController@data')->name('admin.tag.data');
        Route::get('tag', 'TagController@index')->name('admin.tag');
        //添加
        Route::get('tag/create', 'TagController@create')->name('admin.tag.create')->middleware('permission:home.tag.create');
        Route::post('tag/store', 'TagController@store')->name('admin.tag.store')->middleware('permission:home.tag.create');
        //编辑
        Route::get('tag/{id}/edit', 'TagController@edit')->name('admin.tag.edit')->middleware('permission:home.tag.edit');
        Route::put('tag/{id}/update', 'TagController@update')->name('admin.tag.update')->middleware('permission:home.tag.edit');
        //删除
        Route::delete('tag/destroy', 'TagController@destroy')->name('admin.tag.destroy')->middleware('permission:home.tag.destroy');
    });
    //相册管理
    Route::group(['middleware' => 'permission:home.album'], function () {
        Route::get('album/data', 'AlbumController@data')->name('admin.album.data');
        Route::get('album', 'AlbumController@index')->name('admin.album');
        //添加
        Route::get('album/create', 'AlbumController@create')->name('admin.album.create')->middleware('permission:home.album.create');
        Route::post('album/store', 'AlbumController@store')->name('admin.album.store')->middleware('permission:home.album.create');
        //编辑
        Route::get('album/{id}/edit', 'AlbumController@edit')->name('admin.album.edit')->middleware('permission:home.album.edit');
        Route::put('album/{id}/update', 'AlbumController@update')->name('admin.album.update')->middleware('permission:home.album.edit');
        //删除
        Route::delete('album/destroy', 'AlbumController@destroy')->name('admin.album.destroy')->middleware('permission:home.album.destroy');
    });
});
//配置管理
...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'middleware' => ['auth', 'permission:member.manage']], function () {
    ...
    //群聊管理
    Route::group(['middleware' => 'permission:member.group'], function () {
    ...
    Route::group(['middleware' => 'permission:member.member'], function () {
        ...
        //详细信息
        Route::get('member/{id}/info', 'MemberController@info')->name('admin.member.info');
        //添加个人详细信息
        Route::post('member/{id}/info/create', 'MemberController@infoCreate')->name('admin.member.info.create');
        //修改个人详细信息
        Route::post('member/{id}/info/edit', 'MemberController@infoEdit')->name('admin.member.info.edit');
    });
});
//消息管理
...
//单页管理
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'middleware' => ['auth', 'permission:single.manage']], function () {
    //关于我
    Route::group(['middleware' => 'permission:single.about'], function () {
        Route::get('about/data', 'AboutController@data')->name('admin.about.data');
        Route::get('about', 'AboutController@index')->name('admin.about');
    });

    //留言管理
    Route::group(['middleware' => 'permission:single.communication'], function () {
        Route::get('communication/data', 'CommunicationController@data')->name('admin.communication.data');
        Route::get('communication', 'CommunicationController@index')->name('admin.communication');
    });
